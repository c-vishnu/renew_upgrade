        ...
        <div className="sub-hero">
          <div className="sub-hero__plan">
            ...
            <p className="sub-hero__price">
              ...
              <span className="sub-hero__cycle">
                {inr(subscription.monthlyTotal * subscription.termMonths)} billed {termLabel(subscription.termMonths)}
              </span>
            </p>
          </div>

          <div className="sub-hero__renewal">
            <p className="sub-hero__label">Next renewal</p>
          ...
          {latestInvoice && (
            <div className="sub-hero__payment">
              <p className="sub-hero__label">Last payment</p>
          ...
          <div className="sub-hero__actions">
            ...
            <button type="button" className="btn btn--secondary btn--sm" onClick={onAddModules}>
